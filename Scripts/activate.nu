...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\loren\PycharmProjects\WeatherAirQuality_WebApp\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\loren\PycharmProjects\WeatherAirQuality_WebApp\venv\Scripts\deactivate.nu'
